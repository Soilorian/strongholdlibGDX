...
public enum Troops {
    ARCHER("Archer", Speed.FAST, Price.FREE, HP.LOW, Range.HIGH,
            Damage.LOW, new ArrayList<>(List.of(new Resource[]{new Resource(Resources.BOW, 1)}))),
    ...
    SWORDSMAN("Swordsman", Speed.VERY_SLOW, Price.FREE, HP.VERY_LOW, Range.VERY_LOW,
            Damage.VERY_HIGH, new ArrayList<>(List.of(new Resource[]{new Resource(Resources.SWORD, 1), new Resource(Resources.CHESTPLATE, 1)}))),
    KNIGHT("Knight", Speed.VERY_FAST, Price.FREE, HP.HIGH, Range.VERY_LOW,
            Damage.VERY_HIGH, new ArrayList<>(List.of(new Resource[]{new Resource(Resources.SWORD, 1), new Resource(Resources.CHESTPLATE, 1)}))),
    BLACK_MONK("Black Monk", Speed.SLOW, Price.FREE, HP.MEDIUM, Range.VERY_LOW, Damage.MEDIUM, new ArrayList<>()),
    LADDER_MAN("LadderMan", Speed.VERY_FAST, Price.VERY_CHEAP, HP.MEDIUM, Range.VERY_LOW, Damage.LOW, new ArrayList<>()),
    ARCHER_BOW("Archer Bow", Speed.FAST, Price.CHEAP, HP.LOW, Range.VERY_HIGH, Damage.LOW, new ArrayList<>()),
    SLAVE("Slave", Speed.FAST, Price.VERY_CHEAP, HP.VERY_LOW, Range.VERY_LOW, Damage.VERY_LOW, new ArrayList<>()),
    SLINGER("Slinger", Speed.FAST, Price.MEDIUM, HP.VERY_LOW, Range.LOW, Damage.LOW, new ArrayList<>()),
    ASSASSIN("Assassin", Speed.MEDIUM, Price.VERY_EXPENSIVE, HP.MEDIUM, Range.VERY_LOW, Damage.MEDIUM, new ArrayList<>()),
    HORSE_ARCHER("Horse Archer", Speed.VERY_FAST, Price.MEDIUM, HP.MEDIUM, Range.MEDIUM, Damage.LOW, new ArrayList<>()),
    ARABIAN_SWORDSMAN("Arabian Swordsman", Speed.VERY_FAST, Price.EXPENSIVE, HP.HIGH, Range.VERY_LOW, Damage.HIGH, new ArrayList<>()),
    FIRE_THROWER("Fire Thrower", Speed.VERY_FAST, Price.CHEAP, HP.LOW, Range.LOW, Damage.HIGH, new ArrayList<>()),
    PEASANT("peasant", Speed.FAST, Price.FREE, HP.LOW, Range.VERY_LOW, Damage.VERY_LOW, new ArrayList<>()),

    LORD("lord", Speed.SLOW, Price.FREE, HP.VERY_HIGH, Range.VERY_LOW, Damage.VERY_HIGH, new ArrayList<>()),
    DOG("wilde dog", Speed.FAST, Price.FREE, HP.LOW, Range.VERY_LOW, Damage.MEDIUM, new ArrayList<>()),
    CATAPULT("siege weapon", Speed.VERY_SLOW, Price.MEDIUM, HP.HIGH, Range.HIGH, Damage.HIGH,
            new ArrayList<>(List.of(new Resource[]{new Resource(Resources.WOOD, 10)}))),
    ...
    Troops(String name, Speed speed, Price price, HP hp, Range range, Damage damage, ArrayList<Resource> equipments) {
        this.name = name;
        this.speed = speed;
        this.price = price;
        this.hp = hp;
